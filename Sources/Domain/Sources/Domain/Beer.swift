...
public struct Beer: Codable, Equatable, Identifiable {
    ...
    public init(id: Int, name: String, tagline: String, firstBrewed: String, description: String, imageURL: String?, abv: Double, ingredients: Ingredients, foodPairing: [String]) {
        self.id = id
        self.name = name
    ...
    public static func sample() -> Beer {
        Beer(id: 1,
             ...
             tagline: "A nice beer",
             firstBrewed: "09/2007",
             description: "A very nice beer indeed",
...
public struct Ingredients: Codable {
    ...
    public init(malt: [Malt], hops: [Hop], yeast: String? = nil) {
        self.malt = malt
        self.hops = hops
        self.yeast = yeast
    }
